      ...
      body: candidatosAsync.when(
        data: (candidaturas) {
          if (candidaturas.isEmpty) {
            return const Center(child: Text('Nenhuma candidatura ainda'));
          }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('⭐ ${_formatRating(candidatura.profissionalMediaAvaliacoes)}'),
                        const SizedBox(height: 4),
                        if (candidatura.profissionalCategoria != null &&
                            candidatura.profissionalCategoria!.isNotEmpty)
                          Text('Categoria: ${candidatura.profissionalCategoria}'),
                        if (candidatura.profissionalDescricao != null &&
                            candidatura.profissionalDescricao!.trim().isNotEmpty)
                          Text('Habilidades: ${candidatura.profissionalDescricao}'),
                        const SizedBox(height: 6),
                            ...
                            Expanded(
                              child: OutlinedButton(
                                onPressed: actionState.isLoading
                                    ...
                                    : () async {
                                        await ref
                                            .read(vagaActionControllerProvider
                                                .notifier)
